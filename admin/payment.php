...
<body>
    ...
    <div class="roombooktable" class="table-responsive-xl">
        <?php
            // Corrected table name from 'payments' to 'roombook' as per the columns being accessed
            $paymanttablesql = "SELECT * FROM roombook";
        ...
        <table class="table table-bordered" id="table-data">
            <thead>
                <tr>
                    ...
                    <th scope="col">Check Out</th> <!-- Corrected "Check In" to "Check Out" -->
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo $res['BedType'] ?></td> <!-- Changed 'Bed' to 'BedType' -->
                    <td><?php echo $res['CheckIn'] ?></td> <!-- Changed 'cin' to 'CheckIn' -->
                    <td><?php echo $res['CheckOut'] ?></td> <!-- Changed 'cout' to 'CheckOut' -->
                    <td><?php echo $res['noofdays'] ?></td>
                    <td><?php echo $res['NumberOfRooms'] ?></td> <!-- Changed 'NoofRoom' to 'NumberOfRooms' -->
